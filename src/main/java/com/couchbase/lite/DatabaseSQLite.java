 ...
 */
public final class DatabaseSQLite implements Database {
    ...
    public static void setFilterCompiler(ReplicationFilterCompiler filterCompiler) {
        DatabaseSQLite.filterCompiler = filterCompiler;
    }
    ...
    public DatabaseSQLite(String path, Manager manager) {
    ...
    public Future runAsync(final AsyncTask asyncTask) {
        return getManager().runAsync(new Runnable() {
            @Override
            public void run() {
                asyncTask.run(DatabaseSQLite.this);
            }
        });
    }
    ...
    public static Database createEmptyDBAtPath(String path, Manager manager) {
        ...
        Database result = new DatabaseSQLite(path, manager);
